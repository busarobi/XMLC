...
//			processingThread.run();
			...
			for(int i = 0; i < this.numOfThreads; i++ ) {
				logger.info( "Thread: " +  processingThreads[i].getID() + 
						     " --- Num of processed instances: " + processingThreads[i].getNumOfProcessedInstance() );
			}
	...
	public class UpdateThread implements Runnable{
		...
		public void run() {
			...
			while (true) {
				...
				//System.out.println("Thread " + this.ID +" Processed instance: " + this.numOfProcessedInstance );
